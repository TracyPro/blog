/*! markdown-it 8.4.1 https://github.com//markdown-it/markdown-it @license MIT */
!function (e) {
    ...
    return function e(r, t, n) {
        ...
        1: [function (e, r, t) {
            ...
            function a(e, r) {
                var t = 0;
                return s(d, r) ? d[r] : 35 === r.charCodeAt(0) && f.test(r) && (t = "x" === r[1].toLowerCase() ? parseInt(r.slice(2), 16) : parseInt(r.slice(1), 10), o(t)) ? i(t) : e
            }
            ...
            var l = Object.prototype.hasOwnProperty, u = /\\([!"#$%&'()*+,\-.\/:;<=>?@[\\\]^_`{|}~])/g,
                p = /&([a-z#][a-z0-9]{1,31});/gi, h = new RegExp(u.source + "|" + p.source, "gi"),
                f = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))/i, d = e("./entities"), m = /[&<>"]/, _ = /[&<>"]/g,
                g = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;"}, b = /[.?*+^$[\]\\(){}|-]/g,
            ...
            r.exports = function (e, r, t) {
                ...
                return a === r ? c : 0 !== i ? c : (c.str = s(e.slice(a, r)), c.lines = 0, c.pos = r, c.ok = !0, c)
            }
            ...
            r.exports = function (e, r, t, s) {
                var o, i, a, c, l, u, p, h, f, d, m, _, g, b, k, v, x, y, C, A, w = e.lineMax,
                ...
                for (m = [e.bsCount[r]], e.bsCount[r] = e.sCount[r] + 1 + (v ? 1 : 0), u = D >= E, b = [e.sCount[r]], e.sCount[r] = f - c, k = [e.tShift[r]], e.tShift[r] = D - e.bMarks[r], y = e.md.block.ruler.getRules("blockquote"), g = e.parentType, e.parentType = "blockquote", A = !1, h = r + 1; h < t && (e.sCount[h] < e.blkIndent && (A = !0), D = e.bMarks[h] + e.tShift[h], E = e.eMarks[h], !(D >= E)); h++) if (62 !== e.src.charCodeAt(D++) || A) {
                    if (u) break;
                    for (x = !1, a = 0, l = y.length; a < l; a++) if (y[a](e, h, t, !0)) {
                        x = !0;
                        break
                    }
                    if (x) {
                ...
                for (_ = e.blkIndent, e.blkIndent = 0, (C = e.push("blockquote_open", "blockquote", 1)).markup = ">", C.map = p = [r, 0], e.md.block.tokenize(e, r, h), (C = e.push("blockquote_close", "blockquote", -1)).markup = ">", e.lineMax = w, e.parentType = g, p[1] = e.line, a = 0; a < k.length; a++) e.bMarks[a + r] = d[a], e.tShift[a + r] = k[a], e.sCount[a + r] = b[a], e.bsCount[a + r] = m[a];
            ...
            r.exports = function (e, r, t, n) {
                ...
                if (u = e.src.slice(c, h), (i = e.src.slice(h, f)).indexOf(String.fromCharCode(s)) >= 0) return !1;
                if (n) return !0;
            ...
            function n(e, r) {
                var t, n, s, o;
                return n = e.bMarks[r] + e.tShift[r], s = e.eMarks[r], 42 !== (t = e.src.charCodeAt(n++)) && 45 !== t && 43 !== t ? -1 : n < s && (o = e.src.charCodeAt(n), !i(o)) ? -1 : n
            }
            ...
            r.exports = function (e, r, t, i) {
                ...
                if (e.sCount[r] - e.blkIndent >= 4) return !1;
                if (i && "paragraph" === e.parentType && e.tShift[r] >= e.blkIndent && (R = !0), (S = s(e, r)) >= 0) {
                ...
                for (g = e.tokens.length, f ? (I = e.push("ordered_list_open", "ol", 1), 1 !== k && (I.attrs = [["start", k]])) : I = e.push("bullet_list_open", "ul", 1), I.map = _ = [r, 0], I.markup = String.fromCharCode(b), x = r, F = !1, T = e.md.block.ruler.getRules("list"), w = e.parentType, e.parentType = "list"; x < t;) {
                    for (q = S, v = e.eMarks[x], h = y = e.sCount[x] + S - (e.bMarks[r] + e.tShift[r]); q < v;) {
                        if (9 === (a = e.src.charCodeAt(q))) y += 4 - (y + e.bsCount[x]) % 4; else {
                            if (32 !== a) break;
                            y++
                        }
                        q++
                    }
                    if (c = q, (p = c >= v ? 1 : y - h) > 4 && (p = 1), u = h + p, I = e.push("list_item_open", "li", 1), I.markup = String.fromCharCode(b), I.map = d = [r, 0], C = e.blkIndent, E = e.tight, D = e.tShift[r], A = e.sCount[r], e.blkIndent = u, e.tight = !0, e.tShift[r] = c - e.bMarks[r], e.sCount[r] = y, c >= v && e.isEmpty(r + 1) ? e.line = Math.min(e.line + 2, t) : e.md.block.tokenize(e, r, t, !0), e.tight && !F || (M = !1), F = e.line - r > 1 && e.isEmpty(e.line - 1), e.blkIndent = C, e.tShift[r] = D, e.sCount[r] = A, e.tight = E, I = e.push("list_item_close", "li", -1), I.markup = String.fromCharCode(b), x = r = e.line, d[1] = x, c = e.bMarks[r], x >= t) break;
                ...
                return I = f ? e.push("ordered_list_close", "ol", -1) : e.push("bullet_list_close", "ul", -1), I.markup = String.fromCharCode(b), _[1] = x, e.line = x, e.parentType = w, M && o(e, g), !0
            }
            ...
            r.exports = function (e, r, t, o) {
                var i, a, c, l, u, p, h, f, d, m, _, g, b, k, v, x, y = 0, C = e.bMarks[r] + e.tShift[r],
                    A = e.eMarks[r], w = r + 1;
                if (e.sCount[r] - e.blkIndent >= 4) return !1;
                ...
                for (C = d + 2; C < A; C++) if (10 === (i = b.charCodeAt(C))) y++; else if (!s(i)) break;
                if (!(_ = e.md.helpers.parseLinkDestination(b, C, A)).ok) return !1;
                if (u = e.md.normalizeLink(_.str), !e.md.validateLink(u)) return !1;
                for (a = C = _.pos, c = y += _.lines, g = C; C < A; C++) if (10 === (i = b.charCodeAt(C))) y++; else if (!s(i)) break;
                for (_ = e.md.helpers.parseLinkTitle(b, C, A), C < A && g !== C && _.ok ? (x = _.str, C = _.pos, y += _.lines) : (x = "", C = a, y = c); C < A && (i = b.charCodeAt(C), s(i));) C++;
                if (C < A && 10 !== b.charCodeAt(C) && x) for (x = "", C = a, y = c; C < A && (i = b.charCodeAt(C), s(i));) C++;
            ...
            r.exports = function (e, r, t, i) {
                ...
                for (d = e.push("tr_close", "tr", -1), d = e.push("thead_close", "thead", -1), (d = e.push("tbody_open", "tbody", 1)).map = b = [r + 2, 0], p = r + 2; p < t && !(e.sCount[p] < e.blkIndent) && -1 !== (c = n(e, p).trim()).indexOf("|") && !(e.sCount[p] - e.blkIndent >= 4); p++) {
                    for (h = s(c.replace(/^\||\|$/g, "")), d = e.push("tr_open", "tr", 1), u = 0; u < f; u++) d = e.push("td_open", "td", 1), m[u] && (d.attrs = [["style", "text-align:" + m[u]]]), (d = e.push("inline", "", 0)).content = h[u] ? h[u].trim() : "", d.children = [], d = e.push("td_close", "td", -1);
            ...
            r.exports = function (e) {
                ...
                if (e.md.options.linkify) for (t = 0, i = x.length; t < i; t++) if ("inline" === x[t].type && e.md.linkify.pretest(x[t].content)) for (_ = 0, r = (a = x[t].children).length - 1; r >= 0; r--) if ("link_close" !== (l = a[r]).type) {
                    if ("html_inline" === l.type && (n(l.content) && _ > 0 && _--, s(l.content) && _++), !(_ > 0) && "text" === l.type && e.md.linkify.test(l.content)) {
                        ...
                        d < h.length && ((c = new e.Token("text", "", 0)).content = h.slice(d), c.level = m, u.push(c)), x[t].children = a = o(a, r, u)
                    }
            ...
            function s(e) {
                var r, t, s = 0;
                for (r = e.length - 1; r >= 0; r--) "text" !== (t = e[r]).type || s || (t.content = t.content.replace(c, n)), "link_open" === t.type && "auto" === t.info && s--, "link_close" === t.type && "auto" === t.info && s++
            }

            function o(e) {
                var r, t, n = 0;
                for (r = e.length - 1; r >= 0; r--) "text" !== (t = e[r]).type || n || i.test(t.content) && (t.content = t.content.replace(/\+-/g, "\xb1").replace(/\.{2,}/g, "\u2026").replace(/([?!])\u2026/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---([^-]|$)/gm, "$1\u2014$2").replace(/(^|\s)--(\s|$)/gm, "$1\u2013$2").replace(/(^|[^-\s])--([^-\s]|$)/gm, "$1\u2013$2")), "link_open" === t.type && "auto" === t.info && n--, "link_close" === t.type && "auto" === t.info && n++
            }
                ...
                for (D = [], t = 0; t < e.length; t++) {
                    ...
                    if (D.length = A + 1, "text" === s.type) {
                        ...
                        e:for (; h < f && (l.lastIndex = h, p = l.exec(c));) {
                            if (y = C = !0, h = p.index + 1, w = "'" === p[0], _ = 32, p.index - 1 >= 0) _ = c.charCodeAt(p.index - 1); else for (A = t - 1; A >= 0 && ("softbreak" !== e[A].type && "hardbreak" !== e[A].type); A--) if ("text" === e[A].type) {
                                _ = e[A].content.charCodeAt(e[A].content.length - 1);
                                break
                            }
                            if (g = 32, h < f) g = c.charCodeAt(h); else for (A = t + 1; A < e.length && ("softbreak" !== e[A].type && "hardbreak" !== e[A].type); A++) if ("text" === e[A].type) {
                                g = e[A].content.charCodeAt(0);
                                break
                            }
                            if (b = a(_) || i(String.fromCharCode(_)), k = a(g) || i(String.fromCharCode(g)), v = o(_), (x = o(g)) ? y = !1 : k && (v || b || (y = !1)), v ? C = !1 : b && (x || k || (C = !1)), 34 === g && '"' === p[0] && _ >= 48 && _ <= 57 && (C = y = !1), y && C && (y = !1, C = k), y || C) {
                                if (C) for (A = D.length - 1; A >= 0 && (m = D[A], !(D[A].level < d)); A--) if (m.single === w && D[A].level === d) {
                                    m = D[A], w ? (E = r.md.options.quotes[2], q = r.md.options.quotes[3]) : (E = r.md.options.quotes[0], q = r.md.options.quotes[1]), s.content = n(s.content, p.index, q), e[m.token].content = n(e[m.token].content, m.pos, E), h += q.length - 1, m.token === t && (h += E.length - 1), f = (c = s.content).length, D.length = A;
                                    continue e
                                }
                                y ? D.push({
                                    token: t,
            ...
            r.exports = function (e, r) {
                ...
                if (u + 1 < p) if (35 === e.src.charCodeAt(u + 1)) {
                    if (l = e.src.slice(u).match(a)) return r || (t = "x" === l[1][0].toLowerCase() ? parseInt(l[1].slice(1), 16) : parseInt(l[1], 10), e.pending += i(o(t) ? t : 65533)), e.pos += l[0].length, !0
            ...
            r.exports = function (e, r) {
                var t, o, i, a = e.pos;
                return !!e.md.options.html && (i = e.posMax, !(60 !== e.src.charCodeAt(a) || a + 2 >= i) && (!(33 !== (t = e.src.charCodeAt(a + 1)) && 63 !== t && 47 !== t && !n(t)) && (!!(o = e.src.slice(a).match(s)) && (r || (e.push("html_inline", "", 0).content = e.src.slice(a, a + o[0].length)), e.pos += o[0].length, !0))))
            }
            ...
            n.prototype.pushPending = function () {
                ...
                return s = d - e, n = d < g ? this.src.charCodeAt(d) : 32, p = a(t) || i(String.fromCharCode(t)), f = a(n) || i(String.fromCharCode(n)), u = o(t), (h = o(n)) ? m = !1 : f && (u || p || (m = !1)), u ? _ = !1 : p && (h || f || (_ = !1)), r ? (c = m, l = _) : (c = m && (!_ || p), l = _ && (!m || f)), {
                    can_open: c,
                    can_close: l,
                    length: s
                }
            ...
            function d(r) {
                ...
                r.__compiled__ = {}, Object.keys(r.__schemas__).forEach(function (e) {
                    ...
                    if (null !== t) {
                        ...
                        if (r.__compiled__[e] = s, i(t)) return a(t.validate) ? s.validate = h(t.validate) : c(t.validate) ? s.validate = t.validate : n(e, t), void(c(t.normalize) ? s.normalize = t.normalize : t.normalize ? n(e, t) : s.normalize = f());
                        o(t) ? d.push(e) : n(e, t)
                    }
            ...
            function g(e, r) {
                ...
                r || u(e) && (r = e, e = {}), this.__opts__ = n({}, b, r), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = n({}, k, e), this.__compiled__ = {}, this.__tlds__ = x, this.__tlds_replaced__ = !1, this.re = {}, d(this)
            }
            ...
            var s = /^([a-z0-9.+-]+:)/i, o = /:[0-9]*$/, i = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,
                a = ["<", ">", '"', "`", " ", "\r", "\n", "\t"], c = ["{", "}", "|", "\\", "^", "`"].concat(a),
                l = ["'"].concat(c), u = ["%", "/", "?", ";", "#"].concat(l), p = ["/", "?", "#"],
                h = /^[+a-z0-9A-Z_-]{0,63}$/, f = /^([+a-z0-9A-Z_-]{0,63})(.*)$/,
                d = {javascript: !0, "javascript:": !0}, m = {
                    http: !0,
                    https: !0,
                    ftp: !0,
                    gopher: !0,
            ...
            n.prototype.parse = function (e, r) {
                ...
                var g = s.exec(l);
                if (g && (o = (g = g[0]).toLowerCase(), this.protocol = g, l = l.substr(g.length)), (r || g || l.match(/^\/\/[^@\/]+@[^@\/]+/)) && (!(c = "//" === l.substr(0, 2)) || g && d[g] || (l = l.substr(2), this.slashes = !0)), !d[g] && (c || g && !m[g])) {
                    var b = -1;
                    for (t = 0; t < p.length; t++) -1 !== (a = l.indexOf(p[t])) && (-1 === b || a < b) && (b = a);
                    var k, v;
                    for (-1 !== (v = -1 === b ? l.lastIndexOf("@") : l.lastIndexOf("@", b)) && (k = l.slice(0, v), l = l.slice(v + 1), this.auth = k), b = -1, t = 0; t < u.length; t++) -1 !== (a = l.indexOf(u[t])) && (-1 === b || a < b) && (b = a);
                    ...
                    if (!y) {
                        ...
                        for (t = 0, n = C.length; t < n; t++) {
                            ...
                            if (A && !A.match(h)) {
                                ...
                                if (!w.match(h)) {
                                    var q = C.slice(0, t), S = C.slice(t + 1), F = A.match(f);
                                    F && (q.push(F[1]), S.unshift(F[2])), S.length && (l = S.join(".") + l), this.hostname = q.join(".");
                                    break
                                }
                            }
                        }
                ...
                var z = l.indexOf("?");
                return -1 !== z && (this.search = l.substr(z), l = l.slice(0, z)), l && (this.pathname = l), m[o] && this.hostname && !this.pathname && (this.pathname = ""), this
            ...
            (function (e) {
                !function (n) {
                    ...
                    function i(e, r) {
                        var t = e.split("@"), n = "";
                        return t.length > 1 && (n = t[0] + "@", e = t[1]), n + o((e = e.replace(F, ".")).split("."), r).join(".")
                    }
                    ...
                    function c(e) {
                        return o(e, function (e) {
                            var r = "";
                            return e > 65535 && (r += I((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), r += I(e)
                        }).join("")
                    }
                    ...
                    function p(e, r, t) {
                        var n = 0;
                        for (e = t ? T(e / A) : e >> 1, e += T(e / r); e > z * y >> 1; n += v) e = T(e / z);
                        return T(n + (z + 1) * e / (e + C))
                    }

                    function h(e) {
                        var r, t, n, o, i, a, u, h, f, d, m = [], _ = e.length, g = 0, b = D, C = w;
                        for ((t = e.lastIndexOf(E)) < 0 && (t = 0), n = 0; n < t; ++n) e.charCodeAt(n) >= 128 && s("not-basic"), m.push(e.charCodeAt(n));
                        for (o = t > 0 ? t + 1 : 0; o < _;) {
                            for (i = g, a = 1, u = v; o >= _ && s("invalid-input"), ((h = l(e.charCodeAt(o++))) >= v || h > T((k - g) / a)) && s("overflow"), g += h * a, f = u <= C ? x : u >= C + y ? y : u - C, !(h < f); u += v) a > T(k / (d = v - f)) && s("overflow"), a *= d;
                            C = p(g - i, r = m.length + 1, 0 == i), T(g / r) > k - b && s("overflow"), b += T(g / r), g %= r, m.splice(g++, 0, b)
                        }
                        return c(m)
                    }
                    ...
                    function f(e) {
                        ...
                        for (_ = (e = a(e)).length, r = D, t = 0, i = w, c = 0; c < _; ++c) (m = e[c]) < 128 && A.push(I(m));
                        for (n = o = A.length, o && A.push(E); n < _;) {
                            for (l = k, c = 0; c < _; ++c) (m = e[c]) >= r && m < l && (l = m);
                            for (l - r > T((k - t) / (g = n + 1)) && s("overflow"), t += (l - r) * g, r = l, c = 0; c < _; ++c) if ((m = e[c]) < r && ++t > k && s("overflow"), m == r) {
                                for (h = t, f = v; d = f <= i ? x : f >= i + y ? y : f - i, !(h < d); f += v) C = h - d, b = v - d, A.push(I(u(d + C % b, 0))), h = T(C / b);
                    ...
                    var g, b, k = 2147483647, v = 36, x = 1, y = 26, C = 38, A = 700, w = 72, D = 128, E = "-",
                        q = /^xn--/, S = /[^\x20-\x7E]/, F = /[\x2E\u3002\uFF0E\uFF61]/g, L = {
                    ...
                    }, d && m) if (r.exports == d) m.exports = g; else for (b in g) g.hasOwnProperty(b) && (d[b] = g[b]); else n.punycode = g
                }(this)
